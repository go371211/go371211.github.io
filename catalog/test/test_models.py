...
class AuthorModelTest(TestCase):
    ...
    def test_last_name_label(self):
        author = Author.objects.get(id = 1)
        filed_label = author._meta.get_field('last_name').verbose_name
        self.assertEqual(filed_label, 'last name')

    def test_date_of_birth_label(self):
        author = Author.objects.get(id = 1)
        filed_label = author._meta.get_field('date_of_birth').verbose_name
        self.assertEqual(filed_label, 'birth')
